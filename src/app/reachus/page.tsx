  ...
  return (
    <>
      ...
      <main className="min-h-screen py-12 px-4 max-w-3xl mx-auto">
        ...
        <p className="mb-4">#156, 27th Cross, 6th Block Jayanagar, Bangalore-560070</p>
        <p className="mb-2">📞 <a href="tel:+919901307850" className="text-blue-600 underline">+91 99013 07850</a></p>
        <p className="mb-2">📧 <a href="mailto:hello@instasquares.in" className="text-blue-600 underline">hello@instasquares.in</a></p>
        <p className="mb-4">
